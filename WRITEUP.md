...
**For the user.** You begin by speaking to our Point app your desired location, whether that's "the closest pharmacy," "take me to Beantown," or "use public transportation to get to Bluestone Lane in Harvard Square." Point works out the correct location, decides on a route, and then leaves you to navigate. Whenever you're not sure which way to go, you point your gloved hand in a direction, and if that's the direction to follow, the glove buzzes. If it isn't, nothing happens, so you just sweep your hand around until you feel the pulse, establish the correct direction, and walk that way. There's no further screen to look at, and no voice telling you to turn left or right (which would require earphones/headphones and further distraction).
